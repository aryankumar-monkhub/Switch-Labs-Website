...
const AboutUs = () => {
  return (
    <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
      <h1 style={{ fontSize: '3rem', marginBottom: '2rem' }}>About Switch Labs</h1>
      <p style={{ fontSize: '1.2rem', lineHeight: '1.6', color: 'var(--color-grey-light)' }}>
        Switch Labs is dedicated to transforming India's heavy-duty fleet operations through our cutting-edge EV ecosystem.
