...
const Policies = () => {
    return (
        <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>1. Information We Collect</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1rem' }}>
                We may collect the following categories of information:
            </p>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', color: 'var(--color-white)' }}>Personal Information</h3>
            ...
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', color: 'var(--color-white)' }}>Technical Information</h3>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', color: 'var(--color-white)' }}>Cookies and Tracking Technologies</h3>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>2. How We Use Your Information</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>3. Sharing of Information</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>4. Data Retention</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>5. Data Security</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>6. Third-Party Services</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>7. Your Rights</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>8. Children's Privacy</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>9. International Data Transfers</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>10. Changes to This Privacy Policy</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>11. Contact Us</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
