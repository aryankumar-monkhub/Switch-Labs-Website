        ...
        <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: 'var(--color-grey-light)' }}>
                    By accessing and using the SwitchLabs website and services, you accept and agree to be bound by the terms and provision of this agreement.
                </p>
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: 'var(--color-grey-light)' }}>
                    All content included on this site, such as text, graphics, logos, images, and software, is the property of SwitchLabs or its content suppliers and protected by international copyright laws.
                </p>
            </section>
            ...
            <section>
                ...
                <p style={{ color: 'var(--color-grey-light)' }}>
                    SwitchLabs shall not be liable for any direct, indirect, incidental, special, or consequential damages that result from the use of, or the inability to use, our services.
                </p>
            </section>
        </div>
    );
