...
const TermsAndConditions = () => {
    return (
        <div className="container" style={{ paddingTop: '8rem', paddingBottom: '4rem' }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>1. About Us</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
                Email: info@switchlabs.in
            </p>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
                Registered Office: [Insert Registered Office Address]
            </p>

            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>2. Acceptance of Terms</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>3. Website Content</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
                The content on this website, including but not limited to:
            </p>
            <ul style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1rem', paddingLeft: '2rem' }}>
                <li>Text</li>
                <li>Graphics</li>
                <li>Logos</li>
                <li>Images</li>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>4. Intellectual Property Rights</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <ul style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '1.5rem', paddingLeft: '2rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>5. User Conduct</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>6. Information Submitted by Users</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>7. No Offer or Solicitation</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>8. Third-Party Links</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>9. Limitation of Liability</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>10. Disclaimer</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>11. Privacy</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>12. Indemnification</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>13. Changes to These Terms</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>14. Governing Law and Jurisdiction</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-white)' }}>15. Contact Information</h2>
            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--color-grey-light)', marginBottom: '0.5rem' }}>
